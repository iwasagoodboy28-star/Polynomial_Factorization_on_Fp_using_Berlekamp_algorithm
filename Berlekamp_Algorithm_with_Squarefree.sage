...
#    f = 1
#    for i in range(10):
#        f += R(randint(10,100)*x^i)
#    if f.degree() <= 1:
#        continue
#    f = f.monic()
#    print("f is",f)
#    print("factoriation is",factor(f))
#    print("factorization by Berlekamp is", Berlekamp_Algorithm_with_Squarefree(f))
#    print()

f = (x^3 + 2*x^2 + x + 1) * (x^6 + 2*x^5 + x^2 + 2*x + 1)
print(Berlekamp_Algorithm(f))
print(Berlekamp_Algorithm_with_Squarefree(f))
print(factor(f))